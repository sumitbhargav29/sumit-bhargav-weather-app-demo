...
class ColorSchemeManager: ObservableObject {
    ...
    @AppStorage("appColorScheme") var storedScheme: String = "system" {
        didSet {
...
extension View {
    /// Applies adaptive foreground color based on color scheme preference
    //    func adaptiveForeground(colorSchemeManager: ColorSchemeManager = ColorSchemeManager.shared, opacity: Double = 1.0) -> some View {
    //        self.foregroundColor(colorSchemeManager.adaptiveForegroundColor(opacity: opacity))
    //    }
