...
//        }
//        // Simulate email confirmation required: return response with nil session
//        // Build a minimal user; dates can’t be nil in some initializers, use Date() defaults.
//        let user = User(
//            id: UUID(),
//            appMetadata: [:],
//            userMetadata: [:],
...
//            isAnonymous: false
//        )
//        return AuthResponse(session: nil, user: user)
//    }
//    
